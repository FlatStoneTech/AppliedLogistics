package com.fireball1725.appliedlogistics.integrations;

import com.fireball1725.appliedlogistics.helpers.LogHelper;
import com.fireball1725.appliedlogistics.integrations.rftools.RFTools;
import com.fireball1725.appliedlogistics.reference.ModIds;
...
public class IntegrationsManager {
    ...
    public void index() {
        ...
        try {
            integrationClasses.put(ModIds.RFTOOLS, RFTools.class);
        } catch (Throwable ex) {
            ex.printStackTrace();
        }
