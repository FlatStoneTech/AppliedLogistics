...
public class PacketGuiSlotAdd implements IMessage, IMessageHandler<PacketGuiSlotAdd, IMessage> {
    ...
    public PacketGuiSlotAdd() {

    }

    public PacketGuiSlotAdd(Class<? extends Slot> guiSlot, int slotID, int locX, int locY, int guiID) {
    ...
    @Override
    public IMessage onMessage(PacketGuiSlotAdd message, MessageContext ctx) {
        ...
        mainThread.addScheduledTask(new Runnable() {
            ...
            public void run() {
                ...
                guiMaker.getGuiMakerContainer().addSlot(message.guiSlot, message.slotID, message.locX, message.locY);
            }
        });
