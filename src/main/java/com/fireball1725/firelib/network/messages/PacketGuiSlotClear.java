...
public class PacketGuiSlotClear implements IMessage, IMessageHandler<PacketGuiSlotClear, IMessage> {
    private int guiID;

    public PacketGuiSlotClear() {
    }

    public PacketGuiSlotClear(int guiID) {
        this.guiID = guiID;
    }
    ...
    @Override
    public IMessage onMessage(PacketGuiSlotClear message, MessageContext ctx) {
        ...
        mainThread.addScheduledTask(new Runnable() {
            ...
            public void run() {
                ...
                guiMaker.getGuiMakerContainer().clearSlots();
            }
        });
