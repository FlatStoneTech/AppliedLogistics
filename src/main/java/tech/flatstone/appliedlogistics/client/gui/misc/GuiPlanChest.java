...
public class GuiPlanChest extends GuiBase {
    private TileEntityPlanChest tileEntity;
    private GuiHelper guiHelper = new GuiHelper();

    public GuiPlanChest(InventoryPlayer inventoryPlayer, TileEntityPlanChest tileEntity) {
        super(new ContainerPlanChest(inventoryPlayer, tileEntity));
