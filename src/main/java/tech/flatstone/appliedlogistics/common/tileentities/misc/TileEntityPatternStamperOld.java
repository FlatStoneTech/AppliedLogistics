...
public class TileEntityPatternStamperOld extends TileEntityMachineBase {
    ...
    //private NBTTagCompound planDetails = new NBTTagCompound();

    private int selectedMachine;

    private List<GuiObject> guiPlanOptions = new ArrayList<>();
    private NBTTagCompound nbtPlanOptions = new NBTTagCompound();
    ...
    public void readFromNBT(NBTTagCompound nbtTagCompound) {
        ...
        this.nbtPlanOptions = nbtTagCompound.getCompoundTag("nbtPlanOptions");
    }
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound nbtTagCompound) {
        ...
        nbtTagCompound.setTag("nbtPlanOptions", this.nbtPlanOptions);
    ...
    public void updateMachinesList(TechLevel planTechLevel, boolean planCreative, boolean clearSelectedPlan) {
        ...
        if (clearSelectedPlan)
            this.nbtPlanOptions = new NBTTagCompound();

        this.markDirty();
        this.markForUpdate();
    }

//    public void updateCheckBox(int checkBoxID, boolean checkBoxValue) {
//        this.planDetails.setBoolean("box" + checkBoxID, checkBoxValue);
//
//        int t = 0;
...
//    }
    ...
    public void updateCheckBoxes() {
        ...
        for (PlanComponent planComponent : planMachine.getPlanComponentList()) {
            ...
            nbtPlanOptions.setBoolean(String.format("checkBoxSelected-%d", i), guiCheckBox.isSelected());
            ...
            y -= 4;
            GuiDrawSimpleImage imageTime2 = new GuiDrawSimpleImage(GuiPatternStamperOld.RESOURCE_BUILD_TIME, 16, y);
            ...
            // Add XP Requirement
            GuiDrawSimpleImage imageXP2 = new GuiDrawSimpleImage(GuiPatternStamperOld.RESOURCE_XP_COST, 16 + 80, y);
        ...
        PacketHandler.INSTANCE.sendToServer(new PacketPatternStamperUpdateCheckBox(this.pos, nbtPlanOptions));
    }

    public void updateNBTPlanDetails(NBTTagCompound nbtTagCompound) {
        this.nbtPlanOptions = nbtTagCompound;
        this.markDirty();
        this.markForUpdate();
    }
    ...
    public NBTTagCompound getNBTPlanOptions() {
        return nbtPlanOptions;
    }
    ...
    public void updateGuiOptions(NBTTagCompound nbtTagCompound) {
        this.nbtPlanOptions = nbtTagCompound;

        int y = 0;
        for (GuiObject option : guiPlanOptions) {
            if (option instanceof GuiCheckBox) {
                option.setSelected(nbtTagCompound.getBoolean(String.format("checkBoxSelected-%d", y)));
            }

            y++;
        }

        LogHelper.info(">>> Update Gui Options");
        LogHelper.info(">>> " + guiPlanOptions.get(0).isSelected());
    }
