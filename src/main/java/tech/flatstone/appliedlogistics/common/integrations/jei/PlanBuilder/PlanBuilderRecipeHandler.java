...
public class PlanBuilderRecipeHandler implements IRecipeHandler<PlanBuilderRecipeJEI> {
    @Nonnull
    @Override
    public Class<PlanBuilderRecipeJEI> getRecipeClass() {
        return PlanBuilderRecipeJEI.class;
    }
    ...
    @Override
    public boolean isRecipeValid(@Nonnull PlanBuilderRecipeJEI planBuilderRecipeJEI) {
        return planBuilderRecipeJEI.getInputs().size() > 0 && planBuilderRecipeJEI.getOutputs().size() > 0;
    }
}
