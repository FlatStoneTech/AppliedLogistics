...
public class BuilderRecipeHandler implements IRecipeHandler<BuilderRecipeJEI> {

    @Nonnull
    @Override
    public Class<BuilderRecipeJEI> getRecipeClass() {
        return BuilderRecipeJEI.class;
    }

    @Nonnull
    @Override
    public String getRecipeCategoryUid() {
        return JeiConstants.BUILDER_CATEGORY;
    }
