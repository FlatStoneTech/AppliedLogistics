...
package tech.flatstone.appliedlogistics.common.integrations.jei.PlanBuilder;
...
import tech.flatstone.appliedlogistics.common.integrations.jei.JeiConstants;
import tech.flatstone.appliedlogistics.common.util.LanguageHelper;

import javax.annotation.Nonnull;

public class PlanBuilderCategory implements IRecipeCategory {
    private static final int INPUT_SLOT = 0;
    private static final int OUTPUT_SLOT = 1;

    @Nonnull
    private final String localizedName = LanguageHelper.JEI.translateMessage("category.plan_builder");

    @Nonnull
    private final IDrawable background = AppliedLogisticsPlugin.jeiHelper.getGuiHelper().createDrawable(new ResourceLocation(ModInfo.MOD_ID + ":textures/gui/jei/plan_builder.png"), 0, 0, 100, 30);

    @Nonnull
    @Override
    public String getUid() {
        return JeiConstants.PLAN_BUILDER_CATEGORY;
    }
    ...
    public void setRecipe(@Nonnull IRecipeLayout iRecipeLayout, @Nonnull IRecipeWrapper iRecipeWrapper) {
        iRecipeLayout.getItemStacks().init(INPUT_SLOT, true, 0, 5);
        iRecipeLayout.getItemStacks().init(OUTPUT_SLOT, false, 73, 5);

        if (iRecipeWrapper instanceof PlanBuilderRecipeJEI) {
            PlanBuilderRecipeJEI planBuilderRecipeJEI = (PlanBuilderRecipeJEI) iRecipeWrapper;
            iRecipeLayout.getItemStacks().set(INPUT_SLOT, (ItemStack) planBuilderRecipeJEI.getInputs().get(0));
            iRecipeLayout.getItemStacks().set(OUTPUT_SLOT, (ItemStack) planBuilderRecipeJEI.getOutputs().get(0));
        }
    }
}
