...
public class PlanBuilderRecipeJEI extends BlankRecipeWrapper {
    @Nonnull
    ...
    public PlanBuilderRecipeJEI(@Nonnull ItemStack input, @Nonnull ItemStack output, @Nonnull int expRequired) {
        this.input = input;
        this.output = output;
    ...
    public void drawInfo(@Nonnull Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) {
        guiHelper.drawCenteredStringWithShadow(30, 11, 13, String.valueOf(expRequired), colorXPGreen);
    }
}
