...
public class PlanBuilderRecipeMaker {
    public static List<PlanBuilderRecipeJEI> getRecipes() {
        ArrayList<PlanBuilderRecipeJEI> recipes = new ArrayList<PlanBuilderRecipeJEI>();

        for (Item itemPlan : PlanRegistry.getPlanItems()) {
            ItemStack itemStack = new ItemStack(Items.ITEM_PLAN.getItem());
            ...
            PlanBuilderRecipeJEI recipe = new PlanBuilderRecipeJEI(new ItemStack(Items.ITEM_PLAN_BLANK.getItem()), itemStack, ((IMachinePlan) itemPlan).getPlanRequiredXP());
            recipes.add(recipe);
        }
