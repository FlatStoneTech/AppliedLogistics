...
public class BlockOreStorageBlock extends BlockBase implements IProvideRecipe {
    public static final PropertyEnum<EnumOres> MATERIAL = PropertyEnum.create("material", EnumOres.class);

    public BlockOreStorageBlock() {
    ...
    public void RegisterRecipes() {
        for (EnumOres ore : EnumOres.values()) {
            if (ore.isTypeSet(EnumOreType.STORAGE_BLOCK) && ore.isTypeSet(EnumOreType.INGOT)) {
