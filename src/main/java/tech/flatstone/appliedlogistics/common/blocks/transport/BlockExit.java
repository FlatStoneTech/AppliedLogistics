...
import tech.flatstone.appliedlogistics.common.tileentities.transport.TileEntityExit;

public class BlockExit extends BlockTechBase {
    ...
    public BlockExit() {
        ...
        this.setInternalName("transport_exit");
    }
