...
import tech.flatstone.appliedlogisticsapi.exceptions.CoreInaccessibleException;
...
public enum AppliedLogisticsApi {
    ...
    private static final String CORE_API_FQN = "tech.flatstone.appliedlogistics.core.Api";
